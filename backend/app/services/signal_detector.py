...
class SignalDetector:
    ...
    def detect_rule1_signals(self, data: List[float], limits: ProcessLimits) -> List[Signal]:
        ...
        for index, value in enumerate(data):
            if value > limits.upperLimit or value < limits.lowerLimit:
        ...
        for i in range(len(data) - 2):
            ...
            if upper_count >= 2:
                signals.append(Signal(
                    ...
                    dataPoints=indices,  # Use camelCase field name
            ...
            if side == current_side:
                ...
                if current_run >= 8:
                    signals.append(Signal(
                        ...
                        dataPoints=list(range(run_start, run_start + current_run)),  # Use camelCase field name
